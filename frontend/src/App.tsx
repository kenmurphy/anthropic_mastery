  ...
  return (
    <div className="h-screen bg-white flex">
      ...
      <div
        ...
        style={{ backgroundColor: 'rgb(245, 244, 237)' }}
      >
        {/* Header */}
        <div className="p-4 border-b border-gray-200">
          ...
          <button 
            ...
            className="w-full flex items-center gap-2 px-3 py-2 bg-orange-500 hover:bg-orange-600 text-white rounded-lg transition-colors"
          >
        ...
        <div className="px-4 py-3 border-b border-gray-200">
          <nav className="space-y-1">
            <button className="w-full flex items-center gap-3 px-2 py-2 text-gray-700 hover:bg-gray-100 rounded-md transition-colors text-left">
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4">
              ...
              {streamingContent && (
                <div className="flex justify-start">
                  <div className="max-w-[70%] bg-white border border-gray-200 text-gray-900 rounded-lg p-3">
            ...
            <div className="border-t border-gray-200 p-4 bg-white">
              <form onSubmit={handleSubmit} className="flex gap-2">
                <textarea
                  ...
                  className="flex-1 min-h-[40px] max-h-[120px] px-3 py-2 border border-gray-300 rounded-lg resize-none focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent"
                  disabled={isLoading}
                  onKeyDown={(e) => {
              ...
              <form onSubmit={handleSubmit} className="mb-6 flex justify-center">
                <div className="relative w-full max-w-[650px]">
                  <textarea
                    ...
                    className="w-full min-h-[120px] pr-20 bg-white border border-gray-300 rounded-[16px] resize-none focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent text-gray-900 placeholder-gray-500"
                  ...
                  <button
                    type="submit"
                    disabled={!message.trim() || isLoading}
                    className="absolute right-3 bottom-3 p-2 bg-orange-500 text-white rounded-lg hover:bg-orange-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                  >
                    {isLoading ? (
                      <div className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin" />
                    ) : (
