...
class OpenAIService:
    """Service for handling OpenAI API interactions with streaming support"""
    ...
    def __init__(self):
        ...
        self.models = {
            'research': 'gpt-4',  # Complex reasoning for sidebar
            'snippets': 'gpt-3.5-turbo',  # Fast edits for Command-K
            'cards': 'gpt-4'  # Comprehensive analysis for cards
        }
...
Please provide your analysis:"""
    ...
    def stream_conversation_response(
        ...
        """
        Stream ChatGPT conversation responses
        ...
        try:
            ...
            messages = [
                {
                    "role": "system", 
                    "content": "You are ChatGPT, a helpful AI assistant. Provide helpful, accurate, and engaging responses to user questions and requests."
                }
            ]
    ...
    def generate_conversation_title(self, message_history: List[Dict[str, str]]) -> str:
        ...
        try:
            ...
            messages = [
                {
                    "role": "system",
                    "content": "Generate a concise, descriptive title (max 50 characters) for this conversation. Return only the title, no quotes or extra text."
                },
                {
                    "role": "user",
